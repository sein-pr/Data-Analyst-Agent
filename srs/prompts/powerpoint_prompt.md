...
Tailor the report's depth, tone, and technical language to the primary audience:
- **C-suite / Executives (non-technical):** High-level narrative, minimal jargon, emphasis on business impact and decisions
- **Department managers (mixed technical):** Balanced detail, department-relevant context, actionable focus
- **Data / Analytics team (technical):** Methodology depth, statistical detail, data quality transparency
- **Mixed audience (executives + analysts):** Lead with executive summary and high-level narrative; include technical detail in supporting sections and appendix
...
Define what problem is being solved and the key questions this analysis answers. Align with department context if provided.
...
Surface data limitations, assumptions made, and potential risks or uncertainties that could affect the conclusions.

**11. Recommendations**
Provide clear, specific, actionable steps. Each recommendation must be tied to a specific finding and include its expected business impact.

**12. Conclusion**
Summarize the single most important takeaway and its overall business implication.

**13. Next Steps**
Suggest further analysis, monitoring actions, and implementation ideas.

**14. Appendix** *(Comprehensive depth or when applicable)*
Include additional charts, technical details, or data definitions that support the main report.
...
- Match vocabulary, metric selection, and interpretive framing to the specified industry and audience
